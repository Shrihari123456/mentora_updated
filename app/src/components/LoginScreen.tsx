...
const LoginScreen: React.FC = () => {
  ...
  const {
    ...
    defaultValues: { role: "mentor", id: "", password: "" },
  });
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data, variables) => {
      localStorage.setItem(
        "auth",
        JSON.stringify({ role: variables.role, userDetails: data })
      );
      navigate(
        variables.role === "mentor" ? "/mentor/dashboard" : "/student/dashboard"
      );
    },
    onError: (error) => {
    ...
    >
      ...
      >
        ...
        <Button
          ...
          disabled={mutation.isPending} // Keep the original logic intact
        >
          {mutation.isPending ? (
